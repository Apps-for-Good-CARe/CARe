...
public class SMSRequestSQLiteHelper extends SQLiteOpenHelper {
    ...
    public SMSRequestSQLiteHelper(Context context) {
    ...
    public void onUpgrade(SQLiteDatabase database, int oldVersion,
        ...
        switch (oldVersion) {
            ...
            case 5:
                ...
                values.put(COLUMN_STATUS, SMSStatus.NO_LOCATION.getId());
