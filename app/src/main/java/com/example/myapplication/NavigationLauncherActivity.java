...
//                return true;
    ...
    public void onResume() {
        //System.out.println("ccoococooocoo");
        ...
        handler.postDelayed(runnable = new Runnable() {
            public void run() {
                try{
                    System.out.println("F:LKJ:LKJCNDNOOOENKD");
...
//if the route has been deemed "suspicious" 3 times in a row, then the user is officially in danger and the button will turn red, sending a
                ...
                System.out.println("YAYOIENOFNOIEKL DLKNOIHENFKENOIFNDPIOFNIEONFOIESSNOIESNFENFPON");
                fetchRoute();
            }
        }, delay);
    }
        ...
        builder.build().getRoute(new SimplifiedCallback() {
            ...
            public void onResponse(Call<DirectionsResponse> call, Response<DirectionsResponse> response) {
                if (validRouteResponse(response)) {
                    ...
                    System.out.println(route.geometry());
                    System.out.println(PolylineUtils.decode(route.geometry(), 6).get(0).latitude());
                    System.out.println(PolylineUtils.decode(route.geometry(), 6).get(0).longitude());
